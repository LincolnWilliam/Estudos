...
#OBS: se o método for chamado sem que se passe um bloco,
# o ruby levanta uma Exception no block given (LocalJumpError)
 
def tem_bloco?  # ? pra ver se retorna true ou false.
  if block_given?
    yield
  else
    puts "nenhum bloco"
...
tem_bloco? {puts "Olá"}
tem_bloco?  # retorna nenhum bloco , nao foi passado bloco.